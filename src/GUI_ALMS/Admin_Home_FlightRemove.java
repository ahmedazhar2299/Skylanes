 ...
 * @author ahmed
 */
public class Admin_Home_FlightRemove extends javax.swing.JFrame {

    /**
     * Creates new form Admin_Home_AddFlights
     */
    public Admin_Home_FlightRemove() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Remove a Flight : ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Home_FlightRemove.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Home_FlightRemove().setVisible(true);
            }
        });
    }
